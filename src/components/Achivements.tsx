  ...
  return (
    <>
      <div className="rounded-lg">
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
